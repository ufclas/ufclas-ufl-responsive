...
class Securimage {
    ...
    function Securimage() {
        ...
        $this->image_bg_color = new Securimage_Color(0xe3, 0xda, 0xed);
        $this->text_color = new Securimage_Color(0xff, 0x00, 0x00);
        $this->multi_text_color = array(new Securimage_Color(0x0a, 0x68, 0xdd),
            new Securimage_Color(0xf6, 0x5c, 0x47),
            new Securimage_color(0x8d, 0x32, 0xfd));
        $this->use_multi_text = true;

        $this->use_transparent_text = true;
        $this->text_transparency_percentage = 15;

        $this->num_lines = 2;
        $this->line_color = new Securimage_Color(0x80, 0xbf, 0xff);
...
//function
    ...
    function saveData() {
        ...
        // added below code so the saved code is only wiped out when a new one has been generated
    ...
    function validate() {
        ...
        if ($code != '') {
            if ($code == $code_entered) {
                ...
                // commented out the below code because it was causing issue when being used by an widget in a zone that is using output cache.
